 ...
 * Copiado del registro oficial (variante TS-CSS) sin cambios de lógica.
 */
...
const RubberSegment: React.FC<RubberSegmentProps> = ({
  ...
  /* Stackr: al hidratar, la primera medición llega antes de que el recorte
     escuche los cambios y la pastilla queda cubriendo todo el ancho hasta el
     primer toque. Esto vuelve a medir ya montado, forzando un cambio real. */
  useEffect(() => {
    innerW.set(0);
    measure();
    // eslint-disable-next-line react-hooks/exhaustive-deps

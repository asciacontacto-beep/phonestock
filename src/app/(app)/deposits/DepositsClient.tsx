    ...
    <div className="page">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: 16, marginBottom: 32 }}>
        {deposits.map((d: any) => {
          ...
          const valUsd = items.filter((s: any) => s.currency === 'USD').reduce((a: any, b: any) => a + (b.cost_price || 0), 0);
          const valArs = items.filter((s: any) => s.currency === 'ARS').reduce((a: any, b: any) => a + (b.cost_price || 0), 0);
          return (
